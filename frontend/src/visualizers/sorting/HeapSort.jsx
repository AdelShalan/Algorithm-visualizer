...
import { generateSteps } from '../../algorithms/sorting/heap-sort.js';
      ...
      <div className="grid grid-cols-[1fr_280px] gap-5 flex-1 min-h-0">
        <div className="flex flex-col gap-5 overflow-hidden">
          ...
          <div className="bg-white border border-border rounded-[10px] p-5 flex flex-col flex-1 min-h-0">
            <div className="font-mono text-[0.5625rem] tracking-[0.08em] uppercase text-muted mb-4">Heap visualization</div>
