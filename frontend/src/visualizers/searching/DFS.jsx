...
import { generateSteps, generateGraph } from '../../algorithms/searching/DFS';
    ...
    <div className="h-full flex flex-col gap-5">
      ...
      <div className="grid grid-cols-[1fr_280px] gap-5 flex-1 min-h-0">
        <div className="bg-white border border-border rounded-[10px] p-5 flex flex-col overflow-hidden">
          <div className="font-mono text-[0.5625rem] tracking-[0.08em] uppercase text-muted mb-4 flex-shrink-0">DFS traversal</div>
